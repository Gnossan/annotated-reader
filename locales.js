...
${text}`,
    ...
    es: {
        ...
        meddelandenSuffix: "mensajes", nagorGickFel: "Algo salió mal.", kvotSlut: "Has usado todos tus créditos este mes. Actualiza tu plan o compra créditos adicionales.", kvotVarning: "⚠ Te estás acercando a tu límite mensual.", consentText: "AIuda Reader almacena tu información de inicio de sesión y preferencias localmente, y tu correo y datos de uso en nuestros servidores. El texto que anotas se envía a la API Claude de Anthropic.", consentLank: "Política de privacidad", consentKnapp: "Acepto",
    ...
    fr: {
        ...
        meddelandenSuffix: "messages", nagorGickFel: "Quelque chose s'est mal passé.", kvotSlut: "Vous avez utilisé tous vos crédits ce mois-ci. Mettez à niveau votre forfait ou achetez des crédits.", kvotVarning: "⚠ Vous approchez de votre limite mensuelle.", consentText: "AIuda Reader stocke vos informations de connexion et préférences localement, et votre e-mail et données d'utilisation sur nos serveurs. Le texte annoté est envoyé à l'API Claude d'Anthropic.", consentLank: "Politique de confidentialité", consentKnapp: "J'accepte",
    ...
    it: {
        ...
        meddelandenSuffix: "messaggi", nagorGickFel: "Qualcosa è andato storto.", kvotSlut: "Hai esaurito tutti i crediti per questo mese. Aggiorna il piano o acquista crediti aggiuntivi.", kvotVarning: "⚠ Stai per raggiungere il limite mensile.", consentText: "AIuda Reader memorizza le tue credenziali e preferenze localmente, e la tua email e i dati di utilizzo sui nostri server. Il testo annotato viene inviato all'API Claude di Anthropic.", consentLank: "Informativa sulla privacy", consentKnapp: "Accetto",
    ...
    no: {
        ...
        meddelandenSuffix: "meldinger", nagorGickFel: "Noe gikk galt.", kvotSlut: "Du har brukt alle kredittene for denne måneden. Oppgrader planen eller kjøp ekstra kreditter.", kvotVarning: "⚠ Du nærmer deg din månedlige grense.", consentText: "AIuda Reader lagrer påloggingsinformasjon og innstillinger lokalt, og e-post og bruksdata på våre servere. Tekst du annoterer sendes til Anthropics Claude API.", consentLank: "Personvernerklæring", consentKnapp: "Jeg godtar",
    ...
    da: {
        ...
        meddelandenSuffix: "beskeder", nagorGickFel: "Noget gik galt.", kvotSlut: "Du har brugt alle dine kreditter for denne måned. Opgrader din plan eller køb ekstra kreditter.", kvotVarning: "⚠ Du nærmer dig din månedlige grænse.", consentText: "AIuda Reader gemmer dine loginoplysninger og indstillinger lokalt samt din e-mail og brugsdata på vores servere. Tekst du annoterer sendes til Anthropics Claude API.", consentLank: "Privatlivspolitik", consentKnapp: "Jeg accepterer",
