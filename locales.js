...
${text}`,
    ...
    fr: {
        ...
        meddelandenSuffix: "messages", nagorGickFel: "Quelque chose s'est mal passé.", kvotSlut: "Vous avez utilisé tous vos crédits ce mois-ci. Mettez à niveau votre forfait ou achetez des crédits.", kvotVarning: "⚠ Vous approchez de votre limite mensuelle.", vipPlan: "VIP — illimité", hanteraPrenumeration: "Gérer l'abonnement →", köpKrediter: "Acheter des crédits", uppgraderaPro: "Passer à Pro — 9,99 €/mois", uppgraderaVip: "Passer à VIP — 19,99 €/mois", consentText: "AIuda Reader stocke vos informations de connexion et préférences localement, et votre e-mail et données d'utilisation sur nos serveurs. Le texte annoté est envoyé à l'API Claude d'Anthropic.", consentLank: "Politique de confidentialité", consentKnapp: "J'accepte",
    ...
    it: {
        ...
        meddelandenSuffix: "messaggi", nagorGickFel: "Qualcosa è andato storto.", kvotSlut: "Hai esaurito tutti i crediti per questo mese. Aggiorna il piano o acquista crediti aggiuntivi.", kvotVarning: "⚠ Stai per raggiungere il limite mensile.", vipPlan: "VIP — illimitato", hanteraPrenumeration: "Gestisci abbonamento →", köpKrediter: "Acquista crediti", uppgraderaPro: "Passa a Pro — €9,99/mese", uppgraderaVip: "Passa a VIP — €19,99/mese", consentText: "AIuda Reader memorizza le tue credenziali e preferenze localmente, e la tua email e i dati di utilizzo sui nostri server. Il testo annotato viene inviato all'API Claude di Anthropic.", consentLank: "Informativa sulla privacy", consentKnapp: "Accetto",
