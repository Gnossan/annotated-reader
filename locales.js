...
${text}`,
    ...
    es: {
        ...
        meddelandenSuffix: "mensajes", nagorGickFel: "Algo salió mal.", kvotSlut: "Has usado todos tus créditos este mes. Actualiza tu plan para continuar.",
    ...
    fr: {
        ...
        meddelandenSuffix: "messages", nagorGickFel: "Quelque chose s'est mal passé.", kvotSlut: "Vous avez utilisé tous vos crédits ce mois-ci. Passez à un forfait supérieur pour continuer.",
    ...
    de: {
        ...
        meddelandenSuffix: "Nachrichten", nagorGickFel: "Etwas ist schiefgelaufen.", kvotSlut: "Sie haben alle Kredite für diesen Monat aufgebraucht. Upgraden Sie Ihren Plan, um fortzufahren.",
    ...
    it: {
        ...
        meddelandenSuffix: "messaggi", nagorGickFel: "Qualcosa è andato storto.", kvotSlut: "Hai esaurito tutti i crediti per questo mese. Aggiorna il tuo piano per continuare.",
    ...
    no: {
        ...
        meddelandenSuffix: "meldinger", nagorGickFel: "Noe gikk galt.", kvotSlut: "Du har brukt alle kredittene for denne måneden. Oppgrader planen din for å fortsette.",
