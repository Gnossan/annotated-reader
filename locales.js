...
${text}`,
    ...
    es: {
        ...
        header: "Annotated Reader", exportera: "↓ Exportar", stallEnFraga: "Haz una pregunta...",
        ingaAndra: "No hay otras anotaciones con historial.", valjMarkering: "Selecciona anotación para referenciar",
        meddelandenSuffix: "mensajes", nagorGickFel: "Algo salió mal.",
        exportRubrik: "Annotated Reader — Historial exportado", exportDatum: "Exportado",
    ...
    fr: {
        ...
        header: "Annotated Reader", exportera: "↓ Exporter", stallEnFraga: "Posez une question...",
        ingaAndra: "Aucune autre annotation avec historique.", valjMarkering: "Sélectionner une annotation à référencer",
        meddelandenSuffix: "messages", nagorGickFel: "Quelque chose s'est mal passé.",
        exportRubrik: "Annotated Reader — Historique exporté", exportDatum: "Exporté",
    ...
    de: {
        ...
        header: "Annotated Reader", exportera: "↓ Exportieren", stallEnFraga: "Stellen Sie eine Frage...",
        ingaAndra: "Keine anderen Annotierungen mit Verlauf.", valjMarkering: "Annotierung zum Querverweisen auswählen",
        meddelandenSuffix: "Nachrichten", nagorGickFel: "Etwas ist schiefgelaufen.",
        exportRubrik: "Annotated Reader — Exportierter Verlauf", exportDatum: "Exportiert",
    ...
    it: {
        ...
        header: "Annotated Reader", exportera: "↓ Esporta", stallEnFraga: "Fai una domanda...",
        ingaAndra: "Nessun'altra annotazione con cronologia.", valjMarkering: "Seleziona annotazione da incrociare",
        meddelandenSuffix: "messaggi", nagorGickFel: "Qualcosa è andato storto.",
        exportRubrik: "Annotated Reader — Cronologia esportata", exportDatum: "Esportato",
    ...
    no: {
        ...
        header: "Annotated Reader", exportera: "↓ Eksporter", stallEnFraga: "Still et spørsmål...",
        ...
        exportRubrik: "Annotated Reader — Eksportert historikk", exportDatum: "Eksportert",
    ...
    da: {
        ...
        header: "Annotated Reader", exportera: "↓ Eksportér", stallEnFraga: "Stil et spørgsmål...",
        ingaAndra: "Ingen andre annoteringer med historik.", valjMarkering: "Vælg annotering til krydsvisen",
        meddelandenSuffix: "beskeder", nagorGickFel: "Noget gik galt.",
        exportRubrik: "Annotated Reader — Eksporteret historik", exportDatum: "Eksporteret",
