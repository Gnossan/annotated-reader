...
${text}`,
    ...
    fr: {
        ...
        meddelandenSuffix: "messages", nagorGickFel: "Quelque chose s'est mal passé.", kvotSlut: "Vous avez utilisé tous vos crédits ce mois-ci. Passez à un forfait supérieur pour continuer.", consentText: "AIuda Reader stocke vos informations de connexion et préférences localement, et votre e-mail et données d'utilisation sur nos serveurs. Le texte annoté est envoyé à l'API Claude d'Anthropic.", consentLank: "Politique de confidentialité", consentKnapp: "J'accepte",
    ...
    it: {
        ...
        meddelandenSuffix: "messaggi", nagorGickFel: "Qualcosa è andato storto.", kvotSlut: "Hai esaurito tutti i crediti per questo mese. Aggiorna il tuo piano per continuare.", consentText: "AIuda Reader memorizza le tue credenziali e preferenze localmente, e la tua email e i dati di utilizzo sui nostri server. Il testo annotato viene inviato all'API Claude di Anthropic.", consentLank: "Informativa sulla privacy", consentKnapp: "Accetto",
    ...
    no: {
        ...
        meddelandenSuffix: "meldinger", nagorGickFel: "Noe gikk galt.", kvotSlut: "Du har brukt alle kredittene for denne måneden. Oppgrader planen din for å fortsette.", consentText: "AIuda Reader lagrer påloggingsinformasjon og innstillinger lokalt, og e-post og bruksdata på våre servere. Tekst du annoterer sendes til Anthropics Claude API.", consentLank: "Personvernerklæring", consentKnapp: "Jeg godtar",
